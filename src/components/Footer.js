...
export default function Footer() {
  return (
    <footer className="bg-custom-dark-violet text-white flex flex-col items-center gap-7 lg:flex-row lg:justify-around lg:h-72 lg:items-start lg:px-10 lg:mx-auto ">
      <div className="mt-14 lg:mt-16 lg:text-left">
      ...
      <ul className="flex flex-col gap-10 mt-5 text-center lg:flex-row lg:mt-16 lg:text-left lg:gap-20">
        <li className="font-bold">
          Features
          <ul className="font-medium mt-4 leading-8 text-sm color-custom-gray-violet">
            <li>
              <a className="link-hover-cyan" href="#">Link Shortening</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Branded Links</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Analytics</a>
            </li>
          </ul>
        </li>
        <li className="font-bold">
          ...
          <ul className="font-medium mt-4 leading-8 text-sm color-custom-gray-violet">
            <li>
              <a className="link-hover-cyan" href="#">Blog</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Developers</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Support</a>
            </li>
          </ul>
        </li>
        <li className="font-bold">
          ...
          <ul className="font-medium mt-4 leading-8 text-sm color-custom-gray-violet">
            <li>
              <a className="link-hover-cyan" href="#">About</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Our Team</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Careers</a>
            </li>
            <li>
              <a className="link-hover-cyan" href="#">Contact</a>
            </li>
          </ul>
        </li>
      </ul>
      <div className="container flex justify-center gap-6 mt-5 pb-20 lg:w-40 lg:mt-16 lg:text-left">
        <a href="#">
          <svg
